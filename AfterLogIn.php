...
<div class="w3-dropdown-content w3-bar-block w3-card-4">
        <a href="http://localhost:1234/pro/LogOut.php" class="w3-bar-item w3-button">LogOut</a>
		</div>
    </div>
  </div>
...
<div class="w3-content" style="max-width:2000px;margin-top:46px">
  ...
  <div class="mySlides w3-display-container w3-center">
    ...
    <a href="http://localhost:1234/pro/upload.php" class="btn" onclick="document.getElementById('id01').style.display='block'">Upload</a>
	</div>
  </div>
